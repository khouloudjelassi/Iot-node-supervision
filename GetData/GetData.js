...
import axios from 'axios';
  ...
  const [
    ...
    const getAllUser = () => {
      axios.get('http://localhost:1337/donnees/').then(function (response){
    ...
    const updateTodo = () => {
      ...
      axios.put(`http://localhost:1337/donnees/${CurentElm.id}`,{temp:temp,
      creatAt:creatAt
...
<div className="form-group">
  <label htmlFor="numS" >Numero de serie</label>
  <input  className="form-control" id="numS" placeholder="numero serie"  
